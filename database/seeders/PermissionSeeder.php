...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'village_vision_missions.view', 'display_name' => 'View Village Vision Mission', 'description' => 'Can view village vision mission management page', 'group' => 'village_vision_missions'],
            ['name' => 'village_vision_missions.edit', 'display_name' => 'Edit Village Vision Mission', 'description' => 'Can edit village vision mission content and mission items', 'group' => 'village_vision_missions'],
