...
class UserList extends Component
{
    ...
    {
        // Jika $params adalah angka langsung, gunakan langsung; kalau array, ambil key-nya
        $userId = is_array($params) ? ($params['userId'] ?? null) : $params;

        if (!$userId) {
            $this->showErrorToast('User ID tidak valid.');
            return;
        }
