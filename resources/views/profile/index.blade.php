        ...
        <div
            ...
            <div class="relative p-8 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        <h1
                            class="text-4xl font-bold mb-2 bg-gradient-to-r from-white to-green-100 bg-clip-text text-transparent">
                            Profile Settings
                        </h1>
                        <p class="text-xl text-green-100">Manage your account information</p>
                    </div>
            ...
            <div class="bg-gradient-to-r from-gray-50 to-green-50 px-6 py-4 border-b border-gray-200">
                <nav class="flex space-x-8">
                    <button onclick="showTab('profile')" id="profile-tab"
                        class="tab-button active flex items-center px-4 py-2 text-sm font-semibold rounded-lg transition-all duration-300">
                    ...
                    <button onclick="showTab('password')" id="password-tab"
                        class="tab-button flex items-center px-4 py-2 text-sm font-semibold rounded-lg transition-all duration-300">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
