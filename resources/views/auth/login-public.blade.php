            ...
            <article class="lg:col-span-2 space-y-6">
                ...
                <div class="rounded-2xl bg-white shadow ring-1 ring-black/5 p-6 md:p-8">
                    ...
                    @if (Route::has('password.request'))
                        <a class="text-green-700 hover:underline" href="{{ route('password.request') }}">
                            Lupa kata sandi?
                        </a>
                    @endif

                    {{-- ... letakkan field Email & Password kamu di sini ... --}}
            ...
            <aside class="space-y-6 lg:sticky lg:top-20">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <p class="mt-1 text-sm text-gray-600">
                                Data pribadi dilindungi dan hanya digunakan untuk verifikasi layanan publik.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-xl bg-white shadow p-5 ring-1 ring-black/5">
                    ...
                    <ul class="text-sm text-gray-700 space-y-1">
                        <li>WhatsApp Admin:
                            <a class="text-green-700 hover:underline" href="https://wa.me/6281234567890">0812-3456-7890</a>
                        </li>
                        <li>Email:
                            <a class="text-green-700 hover:underline"
                                href="mailto:admin@mentuda.go.id">admin@mentuda.go.id</a>
                        </li>
                    </ul>
                </div>
