        ...
        <div class="grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
            <main class="space-y-8">
                <section data-aos="fade-up" data-aos-delay="100"
                    ...
                    @if ($featuredGallery)
                        <a href="{{ route('public.galleries.show', $featuredGallery->slug) }}"
                            class="group relative mt-10 block overflow-hidden rounded-[28px] bg-white shadow-lg ring-1 ring-gray-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:ring-green-200">
                            <article class="relative overflow-hidden rounded-[28px]">
                                <div class="relative h-[340px] overflow-hidden sm:h-[420px] lg:h-[500px]">
                                    ...
                                    <div class="absolute bottom-5 left-5 right-5 text-white md:bottom-8 md:left-8 md:right-8">
                                        ...
                                        <span
                                            class="mt-5 inline-flex items-center rounded-full bg-white/15 px-4 py-2 text-sm font-semibold text-white ring-1 ring-white/20 transition duration-300 group-hover:bg-white/20">
                                            Lihat Seluruh Foto
                                        </span>
                                    </div>
                                </div>
                    ...
                    @if ($galleryAlbums->isNotEmpty())
                        <div class="mt-8 grid gap-5 md:grid-cols-2">
                            @foreach ($galleryAlbums as $album)
                                <a href="{{ route('public.galleries.show', $album->slug) }}" data-aos="fade-up" data-aos-delay="{{ min(($loop->index % 2) * 80, 160) }}"
                                    class="group block overflow-hidden rounded-[28px] border border-gray-200 bg-white shadow-md shadow-gray-200/60 transition duration-300 hover:-translate-y-1 hover:border-green-200 hover:shadow-xl hover:shadow-green-100/60">
                                    ...
                                    <div class="p-5">
                                        ...
                                        <div class="mt-4 inline-flex items-center text-sm font-semibold text-green-700">
                                            Lihat Detail Album
                                        </div>
                                    </div>
                                </a>
                    ...
                    @if ($recentAlbums->isNotEmpty())
                        <div class="space-y-4">
                            @foreach ($recentAlbums as $album)
                                <a href="{{ route('public.galleries.show', $album->slug) }}"
