                        ...
                        <article
                            ...
                            <div class="relative flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                                ...
                                @if ($announcement->event_at)
                                    <span
                                        class="inline-flex w-fit max-w-full shrink-0 items-center gap-1.5 rounded-full bg-green-700 px-3 py-1.5 text-xs font-bold text-white shadow-lg shadow-emerald-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 shrink-0"
                                            fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
