...
@section('content')
    <section
        ...
        <div class="relative mx-auto max-w-7xl px-4 pb-20 pt-8 sm:px-6 lg:px-8">
            ...
            <div class="mt-8 grid gap-10 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-center">
                ...
                <aside
                    class="relative overflow-hidden rounded-[24px] border border-white/10 bg-white/10 p-5 shadow-xl shadow-teal-950/20 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:bg-white/15"
                    data-aos="fade-left">
                    ...
                    <p class="relative text-[11px] font-semibold uppercase tracking-[0.2em] text-emerald-100">
                        Fokus Halaman
                    </p>

                    <div class="relative mt-4 space-y-3 text-xs leading-6 text-white/90">
    ...
    <section class="relative z-10 mx-auto -mt-12 max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        <div class="pointer-events-none absolute right-4 top-32 opacity-[0.05]">
            <svg width="160" height="160" viewBox="0 0 160 160" fill="none">
                @for ($i = 0; $i < 8; $i++)
                    @for ($j = 0; $j < 8; $j++)
                        <circle cx="{{ $i * 20 + 4 }}" cy="{{ $j * 20 + 4 }}" r="2" fill="#166534" />
                    @endfor
                @endfor
            </svg>
        </div>
                    ...
                    <article
                        ...
                        <div class="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
                            <div
                                ...
                                <div class="absolute -right-4 -top-4 h-20 w-20 rounded-full border border-white/10"></div>
                        ...
                        <article
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="min-w-0 flex-1">
                                    ...
                                    <h3
                                        class="mt-4 text-lg font-bold leading-snug text-gray-900 transition group-hover:text-emerald-700">
                                        {{ $announcement->title }}
                                    </h3>
            ...
            <aside class="space-y-6 lg:sticky lg:top-24 lg:self-start">
                <div class="rounded-[24px] border border-gray-200 bg-white p-6 shadow-lg shadow-gray-100/60"
                    ...
                    <div class="mb-5 flex items-center gap-3">
                        <span class="h-8 w-1 rounded-full bg-green-600"></span>
