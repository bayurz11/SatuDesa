@php
    ...
    $metaDescription = 'Pusat pengumuman resmi Desa Mentuda untuk informasi layanan, agenda penting, dan pemberitahuan terbaru.';
...
@section('content')
        ...
        <div class="relative mx-auto max-w-7xl px-4 pb-16 pt-8 sm:px-6 lg:px-8">
            ...
            <div class="mt-6 grid gap-8 lg:grid-cols-[minmax(0,1fr)_340px] lg:items-start">
                <div data-aos="fade-up">
                    ...
                    <h1 class="mt-5 max-w-3xl text-2xl font-bold tracking-tight text-white sm:text-3xl lg:text-[2rem] lg:leading-tight">
                ...
                <aside class="rounded-[24px] border border-white/10 bg-white/10 p-5 shadow-xl shadow-teal-950/20 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:bg-white/15"
                    ...
                    <div class="mt-4 space-y-3 text-xs leading-6 text-white/90">
                        <div class="rounded-2xl bg-white/5 px-4 py-3 ring-1 ring-white/10">
                            Pengumuman yang ditandai unggulan akan muncul paling depan agar informasi mendesak cepat terlihat.
                        </div>
                        <div class="rounded-2xl bg-white/5 px-4 py-3 ring-1 ring-white/10">
                            Gunakan pencarian dan kategori untuk menyaring pengumuman pelayanan, agenda, atau pemberitahuan umum.
                        </div>
                        <div class="rounded-2xl bg-white/5 px-4 py-3 ring-1 ring-white/10">
    ...
    <section class="relative z-10 bg-gradient-to-b from-emerald-50/60 via-white to-white">
        <div class="mx-auto mt-6 max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
            <div class="rounded-[26px] border border-emerald-100 bg-white p-5 shadow-xl shadow-emerald-100/50 sm:p-6"
                data-aos="fade-up">
                <form method="GET" action="{{ route('public.announcements.index') }}"
                    class="grid gap-4 lg:grid-cols-[1.5fr_0.8fr_auto]">
                    <label class="block">
            ...
            <div class="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
                <main class="space-y-6">
                    @if ($featuredAnnouncement)
                        <article class="overflow-hidden rounded-[28px] border border-emerald-100 bg-white shadow-xl shadow-emerald-100/60"
                            data-aos="fade-up">
                            <div class="grid gap-0 lg:grid-cols-[1.1fr_0.9fr]">
                                <div class="relative min-h-[280px] overflow-hidden bg-gradient-to-br from-emerald-100 via-white to-sky-100">
                                    ...
                                    @else
                                        <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_right,_rgba(16,185,129,0.18),_transparent_35%)]"></div>
                                    @endif
                    ...
                    <section class="grid gap-5 md:grid-cols-2">
                        @forelse ($announcements as $announcement)
                            <article class="group rounded-[24px] border border-gray-200 bg-white p-5 shadow-lg shadow-gray-100/60 transition-all duration-300 hover:-translate-y-1 hover:border-emerald-200 hover:shadow-xl"
                                ...
                                <div class="flex items-start gap-4">
                                    <div
                                        ...
                                        <span class="text-[10px] font-semibold uppercase">{{ optional($announcement->published_at)->translatedFormat('M') }}</span>
                                        <strong class="text-2xl leading-none">{{ optional($announcement->published_at)->format('d') }}</strong>
                                    </div>
                                    ...
                                    <div class="min-w-0 flex-1">
                                        ...
                                        <h3 class="mt-3 text-lg font-bold leading-snug text-gray-900 transition group-hover:text-emerald-700">
                                            {{ $announcement->title }}
                                        </h3>
                        ...
                        @empty
                            <div class="md:col-span-2 rounded-[24px] border border-dashed border-gray-300 bg-white px-6 py-12 text-center"
                                ...
                                <p class="mt-2 text-sm text-gray-600">Coba ubah kata kunci pencarian atau pilih kategori lain.</p>
                            </div>
                        @endforelse
                    </section>
