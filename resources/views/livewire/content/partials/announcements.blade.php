<section class="mx-auto max-w-7xl px-4 md:px-6 lg:px-8 mt-8">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:items-start">
        ...
        <article class="lg:col-span-2 space-y-4">
            <div class="lg:col-span-8">
                @forelse ($items as $item)
                    ...
                    <div
                        class="relative overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-black/5 transition hover:shadow-md mb-6 last:mb-0">
        ...
        <aside class="lg:col-span-4 space-y-6 lg:sticky lg:top-20">
            ...
            {{-- Pencarian --}}
            <div role="search" class="bg-white rounded-2xl shadow-sm ring-1 ring-black/5 p-4">
                ...
                <div class="relative">
                    ...
                    <input id="search-q" type="text" wire:model.live="search"
                        ...
                        class="block w-full pl-12 pr-24 py-3 rounded-xl bg-white
                               border border-transparent ring-1 ring-gray-200
            ...
            {{-- Filter --}}
            <div class="bg-white rounded-2xl shadow-sm ring-1 ring-black/5 p-4">
