<div>
    @if ($showModal)
        <div class="fixed inset-0 bg-gray-600 bg-opacity-50 z-50 flex items-center justify-center overflow-y-auto"
            wire:click.self="closeModal" wire:key="struktur-modal" wire:keydown.escape.window="closeModal">
            <div class="relative top-4 mx-auto w-full max-w-6xl p-4 border shadow-lg rounded-2xl bg-white">
                <div class="overflow-hidden flex flex-col">
                    ...
                    <div class="flex-grow rounded-xl overflow-hidden ring-1 ring-gray-100 shadow-sm">
                        {{-- Ganti 'struktur' sesuai nama route publik halaman struktur kamu --}}
                        <iframe id="strukturFrame" wire:ignore src="{{ route('struktur') }}"
    ...
    <script>
        document.addEventListener('livewire:load', function() {
            function bindStrukturIframe() {
                const iframe = document.getElementById('strukturFrame');
