                        ...
                        <td class="px-6 py-5">
                            ...
                            <div class="mt-1 text-xs text-gray-500">
                                ...
                                @foreach ($item->tags as $t)
                                    <span
                                        class="inline-block bg-emerald-50 ring-1 ring-emerald-200 text-emerald-700 rounded px-2 py-0.5 text-[11px] shadow-sm">#{{ $t->name }}</span>
                                @endforeach
                            </div>
                        </td>
                        ...
                        <td class="px-6 py-5 whitespace-nowrap">
                            <span
                                ...
                                {{ [
                                    ...
                                    'scheduled' => 'bg-gradient-to-r from-yellow-100 to-amber-100 text-yellow-800',
                                    'published' => 'bg-gradient-to-r from-green-100 to-emerald-100 text-green-800',
                                    'archived' => 'bg-gradient-to-r from-red-100 to-pink-100 text-red-800',
                        ...
                        <td class="px-6 py-5 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                @permission('informasi.edit')
                                    ...
                                    <button wire:click="togglePublish(@js($item->id))"
