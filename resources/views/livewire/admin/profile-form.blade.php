<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        @if($avatarPreviewUrl)
            <img src="{{ $avatarPreviewUrl }}" alt="{{ $name }}" class="h-16 w-16 rounded-2xl object-cover shadow-lg">
        @else
    ...
    <form wire:submit.prevent="updateProfile" class="space-y-6">
        ...
        <div class="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-200">
            <div class="flex items-center space-x-6">
                @if($avatar)
                    <img src="{{ $avatar->temporaryUrl() }}" alt="Avatar preview" class="h-20 w-20 rounded-2xl object-cover shadow-lg">
                @elseif($avatarPreviewUrl)
                    <img src="{{ $avatarPreviewUrl }}" alt="{{ $name }}" class="h-20 w-20 rounded-2xl object-cover shadow-lg">
                @else
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        @elseif($avatarPreviewUrl)
                            <span class="text-sm text-gray-500 font-medium">Current avatar is active</span>
                        @endif
                    </div>
                    @error('avatar')
